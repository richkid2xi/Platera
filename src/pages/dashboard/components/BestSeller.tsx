    ...
    <div className="bg-white dark:bg-foreground-900 rounded-xl border border-background-200 dark:border-foreground-700 p-5 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group h-full flex flex-col">
      ...
      <div className="flex flex-col">
        {bestSellers.map((item, index) => (
            <div
              key={item.id}
              className="flex items-center gap-3 py-3 px-2 -mx-2 rounded-lg border-b border-transparent border-background-100 dark:border-foreground-800 last:border-b-0 hover:bg-background-50 dark:hover:bg-foreground-800/50 transition-colors cursor-default"
            >
