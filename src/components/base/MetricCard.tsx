...
export default function MetricCard({ label, value, trend, trendUp, vsLabel, icon }: MetricCardProps) {
  return (
    <div className="bg-white dark:bg-foreground-900 rounded-xl p-5 flex flex-col gap-3 border border-background-200 dark:border-foreground-700 hover:border-primary-200 dark:hover:border-primary-800 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 cursor-default animate-fade-in-up group">
